...
// Attempting to create alerts that are generic so it doesn't matter which dog image is clicked. Used IDs (removed from HTML for now) but since we don't have a breed element I couldn't figure out how to do this in time to turn in the assignment
// function dogInfo() {
//   let name = document.getElementById("dog-name").innerHTML;
//   let cost = document.getElementById("dog-cost").innerHTML;
//
//   result = (name + ', ' + cost)
//
//   alert(result);
